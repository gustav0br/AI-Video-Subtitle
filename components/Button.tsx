...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    ...
    secondary: "bg-white hover:bg-slate-50 text-slate-700 border-slate-200 focus:ring-slate-200 dark:bg-slate-700 dark:hover:bg-slate-600 dark:text-slate-100 dark:border-slate-600 dark:focus:ring-slate-500 border",
